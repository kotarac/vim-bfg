...
if !executable('fzf')
  echohl WarningMsg
  echo 'vim-bfg: fzf is not installed or not in your PATH'
  echohl None
  finish
endif
...
if !executable('fd')
  echohl WarningMsg
  echo 'vim-bfg: fd is not installed or not in your PATH'
  echohl None
  finish
endif
...
if !executable('rg')
  echohl WarningMsg
  echo 'vim-bfg: rg is not installed or not in your PATH'
  echohl None
  finish
endif
...
function! s:fzf(opts, source, sink)
  let l:cmd = 'fzf'
